...
class Localisations:
    ...
    def create(self):
        ...
        warp_ville_1 = {'North': (20, 10)}
        warp_ville_2 = {'North': (20, 6), 'South': (20, 10), 'West': (6, 18), 'East': (33, 22)}
        warp_ville_3 = {'East': (51, 15)}
        warp_ville_4 = {"West": (6, 16)}
        warp_ville_5 = {"South": (32, 42)}
        warp_route1 = {"North": (17, 6), "South": (19, 54)}
        warp_route_2 = {'North': (10, 5), 'East': (43, 13)}
        warp_route3 = {'South': (72, 12), 'West': (4, 10)}
        warp_route_5 = {"North": (35, 11), "South": (24, 59)}
        warp_desert = {"West": (7, 9), 'East': (30, 136)}
        warp_grotte2 = {"North", (4, 1), "South", (8, 30)}
