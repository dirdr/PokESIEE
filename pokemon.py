...
class Pokemon(Entity):
    ...
    def __init__(self, id: int, data: Dict[str, Any], ):
        ...
        self.back_image = spritesheet.pick_image(poke_dos.image, (((id - 1) % 31) * 96), int((id - 1) / 31) * 96,
                                                 self.width,
                                                 self.height)
