...
FIRE: Type = Type(2, N_FIRE,
                  {N_FIRE: 0.5, N_WATER: 0.5, N_GRASS: 2, N_ICE: 2, N_BUG: 2, N_ROCK: 0.5, N_DRAGON: 0.5, N_STEEL: 2})
WATER: Type = Type(3, N_WATER, {N_FIRE: 2, N_WATER: 0.5, N_GRASS: 0.5, N_GROUND: 2, N_ROCK: 2, N_DRAGON: 0.5})
GRASS: Type = Type(1, N_GRASS,
                   {N_FIRE: 0.5, N_WATER: 2, N_GRASS: 0.5, N_POISON: 0.5, N_GROUND: 2, N_FLYING: 0.5, N_BUG: 0.5,
                    N_ROCK: 2, N_DRAGON: 0.5, N_STEEL: 0.5})
ELECTRIC: Type = Type(11, N_ELECTRIC,
                      {N_WATER: 2, N_GRASS: 0.5, N_ELECTRIC: 0.5, N_GROUND: 0, N_FLYING: 2, N_DRAGON: 0.5})
ICE: Type = Type(13, N_ICE, {N_WATER: 0.5, N_GRASS: 2, N_ICE: 0.5, N_GROUND: 2, N_FLYING: 2, N_DRAGON: 2, N_STEEL: 0.5})
FIGHTING: Type = Type(4, N_FIGHTING,
                      {N_NORMAL: 2, N_ICE: 2, N_POISON: 0.5, N_FLYING: 0.5, N_PSYCHIC: 0.5, N_DARK: 2, N_BUG: 0.5,
                       N_ROCK: 2, N_GHOST: 0, N_STEEL: 2})
POISON: Type = Type(6, N_POISON,
                    {N_GRASS: 2, N_POISON: 0.5, N_GROUND: 0.5, N_BUG: 2, N_ROCK: 0.5, N_GHOST: 0.5, N_STEEL: 0})
GROUND: Type = Type(7, N_GROUND,
                    {N_FIRE: 2, N_GRASS: 0.5, N_ELECTRIC: 2, N_POISON: 2, N_FLYING: 0, N_BUG: 0.5, N_ROCK: 2,
                     N_STEEL: 2})
...
BUG: Type = Type(9, N_BUG,
                 {N_FIRE: 0.5, N_GRASS: 2, N_FIGHTING: 0.5, N_POISON: 2, N_FLYING: 0.5, N_PSYCHIC: 2, N_DARK: 2,
                  N_GHOST: 0.5, N_STEEL: 0.5})
